     ...
     <div className="relative rounded-2xl p-18 overflow-hidden bg-[#f7fbff]">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-gray-700 mb-10 leading-relaxed">
           At Multiple AI Solutions, we empower businesses to work smarter and achieve more with intelligent,<br className="hidden sm:block" />
          secure technology. Our services are designed to deliver measurable results, streamline operations,<br className="hidden sm:block" />
          and help you stay ahead in a rapidly changing digital world. 
        </p>
        <p className="text-base sm:text-2xl text-gray-800">
          <span className="font-medium text-black">Home</span>{' '}
          <span className="text-indigo-700">›Services</span>
        </p>
      </motion.div>
      </div>
    </div>
